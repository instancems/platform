...
namespace InstanCeMS\Medialib\Providers;

use InstanCeMS\Medialib\Adapters\SourceAdapterFactory;
use InstanCeMS\Medialib\UrlGenerators\UrlGeneratorFactory;
...
class MedialibServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands([
            \InstanCeMS\Medialib\Commands\ImportMediaCommand::class,
            \InstanCeMS\Medialib\Commands\PruneMediaCommand::class,
            \InstanCeMS\Medialib\Commands\SyncMediaCommand::class,
        ]);
    }
}
