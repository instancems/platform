...
namespace InstanCeMS\Medialib;

use InstanCeMS\Medialib\Exceptions\MediaUploadException;
use InstanCeMS\Medialib\Helpers\File;
...
class MediaUploader
{
     ...
     * @param string $class
     * @return static
     * @throws MediaUploadException if $class does not extend InstanCeMS\Medialib\Models\Media
     */
